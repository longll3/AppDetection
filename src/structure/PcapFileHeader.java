...
public class PcapFileHeader {
	...
	public PcapFileHeader(int magic, short magorVersion, short minorVersion, int timezone, int sigflags, int snaplen,
			int linktype) {
		super();
		this.magic = magic;
		this.magorVersion = magorVersion;
	...
	public String toString() {
		return "PcapFileHeader [magic=" + magic + ", magorVersion=" + magorVersion + ", minorVersion=" + minorVersion
				+ ", timezone=" + timezone + ", sigflags=" + sigflags + ", snaplen=" + snaplen + ", linktype="
				+ linktype + "]";
	}
